...
async fn fetch(
    ...
    headers.set(
        ...
        "default-src 'self'; img-src 'self' *.cloudinary.com; style-src 'self' https://fonts.googleapis.com; font-src 'self' https://fonts.gstatic.com; script-src 'self' *.cloudflareinsights.com",
    )?;
